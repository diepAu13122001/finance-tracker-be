...
//     when(goalRepository.findById(GOAL_ID)).thenReturn(Optional.of(goal));
//     when(transactionRepository.sumAmountByGoalIdAndType(GOAL_ID, Transaction.TransactionType.INCOME)).thenReturn(5_000_000L);
//     when(transactionRepository.sumAmountByGoalIdAndType(GOAL_ID, Transaction.TransactionType.EXPENSE)).thenReturn(2_000_000L);

//     goalService.recalculateProgress(GOAL_ID, 5_000_000L);
...
//     when(goalRepository.findById(GOAL_ID)).thenReturn(Optional.of(goal));
//     when(transactionRepository.sumAmountByGoalIdAndType(GOAL_ID, Transaction.TransactionType.INCOME)).thenReturn(2_000_000L);   // trả nợ
//     when(transactionRepository.sumAmountByGoalIdAndType(GOAL_ID, Transaction.TransactionType.EXPENSE)).thenReturn(8_000_000L);  // quẹt thẻ

//     goalService.recalculateProgress(GOAL_ID, 2_000_000L);

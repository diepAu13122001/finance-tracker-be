-- ============================================================
-- V2: Schema khởi tạo cơ bản
-- (Đã bỏ phần GRANT — chạy thủ công 1 lần với superuser)
-- ============================================================
...
INSERT INTO subscription_plans (id, name, price_vnd, billing_cycle, features)
VALUES ('FREE', 'Miễn phí', 0, NULL, '{
  "maxTransactions": 50,
  "maxAiMessages": 0
}'),
       ('PLUS', 'Plus', 0, 'YEARLY', '{
